...
InstallerConfiguration.obtain().then((config: Configuration) => {
    ...
    ReactDOM.render(
        <div className="h-screen flex flex-col gap-y-5 justify-center items-center bg-navy text-gray-100">
            ...
            <span className="w-3/5 text-center text-2xl">We could not configure your installer. Please seek support on the Discord #support-installer channel and provide a screenshot of the following information:</span>

...
function initializeApp() {
        ...
        if (process.env.NODE_ENV !== 'development') {
            ...
            if (packageInfo.version.includes('dev')) {
                updateOptions = {
                    ...
                    url: 'https://cdn.headwindsim.net/installer/dev',
                };
            } else if (packageInfo.version.includes('rc')) {
                updateOptions = {
                    provider:'generic' as const,
                    url: 'https://cdn.headwindsim.net/installer/rc',
                };
            } else {
                updateOptions = {
                    provider:'generic' as const,
                    url: 'https://cdn.headwindsim.net/installer/release',
                };
            }
    ...
    app.setAppUserModelId('Headwind Installer');
